...
class VelAround():
    def __init__(self):
        ...
        rospy.init_node('vel_around', anonymous=False)
        ...
        # Now rotate left roughly 360 degrees  
            
        # Set the angular speed
        move_cmd.angular.z = angular_speed

        rospy.loginfo("angular_duration = %f",angular_duration)
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("vel_around node terminated.")